...
| 优先级 | 事项 |
| --- | --- |
| P0 | **总统杯**：按 [`总统杯_资产映射与英文提案大纲.md`](./总统杯_资产映射与英文提案大纲.md) 写英文 one-pager + demo |
| P1 | 部署 LoRA merged → `TEOCHEW_ASR_URL`，A/B LIVE（总统杯技术证据） |
| P2 | 继续补 L1 近义句 / L2 阿嫲录音 |
| P3 | 适老化与无障碍打磨；可选 MCP |

新开 Agent 会话时可说：

> Read `docs/制作复盘_从零到一.md` and `docs/总统杯_资产映射与英文提案大纲.md`; continue Presidential Hackathon materials.
...
| SUBMIT | EazO 交卷清单与粘贴文案 |
| [总统杯_资产映射与英文提案大纲.md](./总统杯_资产映射与英文提案大纲.md) | 转向总统杯的资产复用与英文大纲 |
